        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-start">
          ...
          <div>
            ...
            <a
              ...
              className="flex items-center justify-center gap-3 w-full bg-[#167A35] hover:bg-[#155C35] text-white font-bold text-lg px-8 py-5 rounded-2xl transition-all shadow-lg hover:shadow-xl hover:-translate-y-0.5 mb-4"
            >
