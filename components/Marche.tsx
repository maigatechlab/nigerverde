...
const icons: Record<string, React.ReactNode> = {
  hotel: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-5 h-5 text-[#155C35]" aria-hidden="true">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-20 items-center">
          ...
          <div className="grid grid-cols-2 gap-3">
            {marche.segments.map((seg) => (
              <div
                key={seg.label}
                className="bg-white rounded-2xl px-4 py-4 border border-[#E3EBE2] shadow-sm flex items-center gap-3 hover:shadow-md hover:border-[#155C35]/20 transition-all duration-200 group"
              >
