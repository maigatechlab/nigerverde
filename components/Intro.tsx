...
const icons: Record<string, React.ReactNode> = {
  greenhouse: (
    <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth={1.5} strokeLinecap="round" strokeLinejoin="round" className="w-7 h-7 text-[#1B9548]" aria-hidden="true">
